...
public class CharacterMove : MonoBehaviour {
    ...
    public void MoveServerside(int i)
    {
        ...
        if (!hit)
        {
            ...
            playerControl.serverNetwork.ClientMove(playerControl.clientNetworkSender.PlayerID, des);
        }
        ...
        else
        {
            ...
            transform.position = des;
            playerControl.serverNetwork.ClientMoveFinished(playerControl.clientNetworkSender.PlayerID, des);
        }
    ...
    public void MoveReleasedServerside(Vector3 position){
        StopCoroutine(moveCycle);
        playerControl.serverNetwork.ClientMoveFinished(playerControl.clientNetworkSender.PlayerID, position);
    }
